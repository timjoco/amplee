          ...
          <Stack spacing={1}>
            ...
            <List disablePadding>
              {items.map((it) => {
                ...
                // ----- Date logic: 0, 1, or many -----
                const dateTsList = (p.options ?? [])
                  .map((o) => (o.starts_at ? +new Date(o.starts_at) : null))
                  .filter((n): n is number => n != null);

                let dateInlineLabel: string;
                if (dateTsList.length === 0) {
                  dateInlineLabel = 'Date TBD';
                } else if (dateTsList.length === 1) {
                  dateInlineLabel = new Intl.DateTimeFormat('en-US', {
                    month: 'short',
                    day: 'numeric',
                    hour: 'numeric',
                    minute: '2-digit',
                  ...
                  dateInlineLabel = 'Multiple date options';
                }
                    ...
                    <ListItemText
                      primary={
                        <Stack
                          ...
                          spacing={1}
                        >
                          <Typography fontWeight={700} noWrap component="span">
